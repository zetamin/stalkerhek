...
(function(){
    ...
    stb.load({
        ...
        // Filter out the genre with id '57'
        genres = genres.filter(function(genre) {
            return genre.id !== '57';
        });

        // Update module with filtered genres
        module.tv.genres = genres;
        module.tv.genre = genres[0]; // Set the first genre as default

        var map = [];

        // Map genres to menu items
            ...
            map.push({
                ...
                "cmd": (function(genre) {
                    return function() {
                        ...
                        if (genre.censored) {
                            module.tv.parent_password_prompt.callback = function() {
                                main_menu.hide();
                                module.tv._show(genre);
                            };
                            module.tv.parent_password_prompt.show();
                        } else {
                            main_menu.hide();
                            module.tv._show(genre);
                        }
        ...
        // Adding filtered genres to the main menu
...
})(); // End of the IIFE for the TV module    